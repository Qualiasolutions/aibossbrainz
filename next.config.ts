...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const cspDirectives = [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://openrouter.ai https://api.elevenlabs.io https://api.tavily.com https://vercel.live https://va.vercel-scripts.com https://*.sentry.io",
      "media-src 'self' blob:",
