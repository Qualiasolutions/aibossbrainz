  ...
  public: {
    Tables: {
      AICostLog: {
        ...
        Relationships: [
          {
            foreignKeyName: "AICostLog_chatId_fkey"
            columns: ["chatId"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "AICostLog_userId_fkey"
            columns: ["userId"]
            isOneToOne: false
      ...
      Chat: {
        Row: {
          ...
          userCategory: Database["public"]["Enums"]["user_category"] | null
          userId: string
          visibility: string
        }
        Insert: {
    ...
    Functions: {
      calculate_subscription_end_date: {
        Args: { start_date: string; sub_type: string }
        Returns: string
      }
      ...
      get_user_personalization: { Args: { p_user_id: string }; Returns: Json }
      is_current_user_admin: { Args: never; Returns: boolean }
      merge_canvas_items: {
        Args: {
          p_canvas_type: string
          p_items: Json
          p_section: string
          p_user_id: string
        }
      ...
      process_webhook_event: {
        Args: { event_id: string; event_type: string; user_id?: string }
        Returns: boolean
      }
      record_user_analytics: {
        Args: {
          p_date: string
          p_export_count?: number
          p_message_count?: number
          p_token_usage?: number
          p_user_id: string
          p_voice_minutes?: number
          p_voice_request_count?: number
        }
        Returns: undefined
      }
    ...
    Enums: {
      user_category: "team" | "client" | "none"
    }
    CompositeTypes: {
      [_ in never]: never
    }
