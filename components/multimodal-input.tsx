	...
	const submitForm = useCallback(() => {
		...
		sendMessage({
			...
			parts: [
				...
				...(hasText ? [{ type: "text" as const, text: input }] : []),
			],
		});
...
function PureAttachmentsButton({
	...
	return (
		<Button
			...
			className="size-8 rounded p-0 text-muted-foreground/70 transition-colors duration-200 hover:bg-transparent hover:text-red-400 sm:size-6"
...
function PureStopButton({
	...
	return (
		<Button
			...
			className="size-11 rounded-xl bg-stone-900 text-white transition-colors duration-200 hover:bg-stone-800"
