...
const ExecutiveBreakdown = dynamicImport(
	() =>
		import("@/components/admin/executive-breakdown").then(
			(mod) => mod.ExecutiveBreakdown,
		),
	{
...
const RevenueFilter = dynamicImport(
	() =>
		import("@/components/admin/revenue-filter").then(
			(mod) => mod.RevenueFilter,
		),
	{
...
// Types - replicated here to avoid server-only import in client component
