...
import { escapeHtml, markdownToHtml } from "@/lib/conversation-export";
...
export function PureMessageActions({
  ...
  const handleExportPdf = async () => {
    ...
    try {
      ...
      // Use markdownToHtml for proper formatting (tables, headers, no raw ---)
      const formattedContent = markdownToHtml(textFromParts);

      // Sanitize the entire HTML to prevent XSS attacks
      tempDiv.innerHTML = DOMPurify.sanitize(
        `<div style="padding: 40px; padding-bottom: 60px; font-family: system-ui, sans-serif; max-width: 800px;">
          ...
          <div style="line-height: 1.7;">${formattedContent}</div>
          <div style="margin-top: 32px; padding-top: 16px; padding-bottom: 40px; margin-bottom: 40px; border-top: 1px solid #e5e5e5; color: #999; font-size: 12px;">
